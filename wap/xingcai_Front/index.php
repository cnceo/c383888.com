...
<body>
    ...
    <div id="wrapper_1" class="scorllmain-content top_bar bottom_bar">
        <div class="sub_ScorllCont">
            ...
            <div class="news-tit"><a href="javascript:;">最新中奖榜</a></div>
                ...
                <div class="news-info">
                    <ul>
                    	...
                    	<?php 
                            ...
                            foreach ($list as $val) {
                                $name = mb_substr($val['nickname'],0,3).'* *';
                        ?>
                            <li>
                                <div class="news-left"><span class="pol-icon"></span><?=$name ?></div>
                                <div class="news-center c-red">喜中<?=$val['bonus']?>元</div>
                               <div class="news-right fr">购买<?=$val['shortName'] ?></div>
                            </li>
                        <?php } ?>
