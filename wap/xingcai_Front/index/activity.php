    ...
    <div class="ui-panel-animate">
        <div class="app-list">
            <div class="app-list-box">
                ...
                <div class="list-pic">
                    <a href="/index.php/index/activity_info?id=1">
                        <img src="/images/activity/a_1.png"></a>
                    <p>活动内容：下载APP</p>
                </div>
                <div class="join">
                    <a href="/index.php/index/activity_info?id=1">查看详情<span class="join-icon"></span></a>
                </div>
            </div>
            <div class="app-list-box">
                <div class="list-tit">
            ...
            <div class="list-pic">
                <a href="/index.php/index/activity_info?id=2">
                    <img src="/images/activity/a_2.jpg"></a>
                <p>活动内容：推荐好友获取收益</p>
            </div>
                <div class="join"><a href="/index.php/index/activity_info?id=2">查看详情<span class="join-icon"></span></a>
                </div>
            </div>
            ...
            <div class="app-list-box"><div class="list-tit"><h3>全民彩票最新热点</h3><p>活动对象：所有会员</p></div><div class="list-pic"><a href="/index.php/index/activity_info?id=4"><img src="/images/activity/4.png"></a><p>活动内容：2000免费试玩 不能提款</p></div><div class="join"><a href="/index.php/index/activity_info?id=4">查看详情<span class="join-icon"></span></a></div></div>
            ...
            <div class="app-list-box"><div class="list-tit"><h3>全民彩票欢迎您</h3><p>活动对象：所有会员</p></div><div class="list-pic"><a href="/index.php/index/activity_info?id=6"><img src="/images/activity/a_6.png"></a><p>活动内容：全民彩票欢迎您</p></div><div class="join"><a href="/index.php/index/activity_info?id=6">查看详情<span class="join-icon"></span></a></div></div>
        </div>
