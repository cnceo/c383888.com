...
<body class="login-bg">
	            ...
	            <ul>
	            	<li>
	                    <a href="/index.php/report/myspread">
	                        <img src="/assets/statics/images/shezhi_04.png" alt="">我的推荐 [<b style="font-size:13px;">推荐好友获取收益</b>]
	                    </a>
	                </li>
	                <li>
	...
	<div class="menu">
	     <ul>
	         ...
	         <li>
	             <a class="menu-my" href="/safe/Personal"><img src="/assets/statics/images/nav_05.png"></a>
	         </li>
	     </ul>
   	</div>
